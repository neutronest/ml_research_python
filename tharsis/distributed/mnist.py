"""
This code come from https://github.com/narumiruna/pytorch-distributed-example/blob/master/mnist/main.py
Which is used here to test the distributed mode and related researching.
"""
